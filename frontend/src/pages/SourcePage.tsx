...
export default function SourcePage({
  ...
  async function loadSource() {
    try {
      ...
      // Clear analysis when opening/reloading
      // a different source.
      setAnalysis("");
    } catch (err) {
      setError(
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Existing AI analysis may no longer
    ...
    return (
      <div className="page">
        <div className="card empty-state">
          ...
          <p>
            This research source may have
            been deleted or no longer exists.
          </p>
        </div>
      </div>
    );
    ...
    <div className="page source-page">
      ...
      {editing ? (
        ...
        <>
          ...
          <div className="card source-info-card">
      ...
      {analysis && (
        <section className="ai-panel">
          ...
          <div className="ai-disclaimer">
            AI-generated analysis is based
            only on the research material
